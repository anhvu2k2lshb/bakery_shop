...
const Checkout = () => {
  ...
  const paymentSubmit = () => {
   if(address1 === "" || address2 === "" || country === "" || city === ""){
      toast.error("Vui lòng điền thông tin đầy đủ địa chỉ nhận hàng!")
   } else{
...
const ShippingInfo = ({
  ...
  return (
    <div className="w-full 800px:w-[95%] bg-white rounded-md p-5 pb-8">
      ...
      >
        *Lựa chọn từ địa chỉ đã lưu (nếu có)
      </h5>
      {userInfo && (
        <div>
          {user &&
  ...
  return (
    <div className="w-full bg-[#fff] rounded-md p-5 pb-8">
      <div className="flex justify-between">
        ...
        <h5 className="text-[18px] font-[600]">{subTotalPrice.toLocaleString('vi-VN', { style: 'currency', currency: 'VND' })}</h5>
      </div>
      <br />
      <div className="flex justify-between">
        <h3 className="text-[16px] font-[400] text-[#000000a4]">Phí vận chuyển:</h3>
        <h5 className="text-[18px] font-[600]">{Number(shipping.toFixed(0)).toLocaleString('vi-VN', { style: 'currency', currency: 'VND' })}</h5>
      </div>
      <br />
      <div className="flex justify-between border-b pb-3">
        <h3 className="text-[16px] font-[400] text-[#000000a4]">Giảm giá:</h3>
        <h5 className="text-[18px] font-[600]">
          - {discountPercentenge ? Number(discountPercentenge.toFixed(0)).toLocaleString('vi-VN', { style: 'currency', currency: 'VND' }) : null}
        </h5>
      </div>
      <h5 className="text-[18px] font-[600] text-end pt-3">{Number(totalPrice).toLocaleString('vi-VN', { style: 'currency', currency: 'VND' })}</h5>
      <br />
