              ...
              <div className="w-full border-t">
                {wishlist &&
                  wishlist.map((i, index) => (
                    <WishSingle key={index} data={i} removeFromWishlistHandler={removeFromWishlistHandler} addToCartHandler={addToCartHandler} />
                  ))}
              </div>
            </div>
          </>
...
const WishSingle = ({ data,removeFromWishlistHandler,addToCartHandler }) => {
